		...
		<section className={`relative ${reverse ? "clip -my-2" : ""}`}>
			...
			>
				<div className="inset-0 bg-black/50 py-16">
					<Parallax speed={-25}>
						<div
							className={`font-basement text-secondary-400 absolute right-[5%] left-[5%] container text-8xl ${
					...
					>
						...
						>
							...
							<h3 className="text-secondary-400 mb-2 text-base md:text-2xl">{title}</h3>
